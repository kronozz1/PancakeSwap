...
export const getCustomMeta = (path: string, t: ContextApi['t']): PageMeta => {
  ...
  switch (basePath) {
    ...
    case '/swap':
      return {
        title: `${t('Exchange')} | ${t('TechSwap')}`,
      }
    case '/add':
      return {
        title: `${t('Add Liquidity')} | ${t('TechSwap')}`,
      }
    case '/remove':
      return {
        title: `${t('Remove Liquidity')} | ${t('TechSwap')}`,
      }
    case '/liquidity':
      return {
        title: `${t('Liquidity')} | ${t('TechSwap')}`,
      }
    case '/find':
      return {
        title: `${t('Import Pool')} | ${t('TechSwap')}`,
      }
    // case '/competition':
    //   return {
